...
export default function Profile() {
  ...
  const renewPeriodDays = 30
  const renewPeriodMs = renewPeriodDays * msInDay
          ...
          <div className="flex flex-col gap-4">
            ...
            <nav className="flex flex-col gap-2">
              ...
              <a
                ...
                className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800/50 cursor-pointer"
              >
...
<p className="text-gray-900 dark:text-white text-4xl font-black leading-tight tracking-[-0.033em]">Панель управления</p>
<p className="text-gray-500 dark:text-[#92a4c9] text-base font-normal leading-normal">Обзор вашей подписки.</p>
</div>
...
<h2 className="text-gray-900 dark:text-white text-lg font-bold leading-tight tracking-[-0.015em] mb-4">Как подключиться</h2>
<div className="flex flex-col gap-4">
