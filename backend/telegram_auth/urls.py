...
urlpatterns = [
    ...
    path("notifications/", notifications_collection, name="notifications_collection"),
    path("notifications/<int:notification_id>/", notification_item, name="notification_item"),
